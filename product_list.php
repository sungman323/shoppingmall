...
<html lang="ko">
  <head>
    ...
    <style>
      ...
      .product_list th{background:#fe980f;color:#fff;}
      ...
      <section>
        <div class="container">
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            echo "<td><a href='#' title='수정'>수정</a> 
            <a href='./php/product_del.php?no=" . $row['no'] . "' onclick='return del_check();'>삭제</a></td>";
            echo '</tr>';
          }
          ?>
          </table>
          <a href="product_mg.php" title="상품등록하기">상품등록하기</a>
        </div>
      </section>
    </main>
